        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-shrink="all" id="lm">
                ...
                <li class="layui-nav-item">
                    ...
                    <a href="javascript:;" id=""><i class="fa fa-shield"></i>&nbsp;考勤管理</a>

                    <dl class="layui-nav-child">

                        <dd><a href="javascript:;" id="" onclick="showTab(1,'/role/list/1','请假加班')">&nbsp;&nbsp;&nbsp;&nbsp;请假加班</a></dd>

                        <dd><a href="javascript:;" id="" onclick="showTab(1,'/menu/list/1','待办事项')">&nbsp;&nbsp;&nbsp;&nbsp;待办事项</a></dd>

                        <dd><a href="javascript:;" id="" onclick="showTab(1,'/user/list/1','我的记录')">&nbsp;&nbsp;&nbsp;&nbsp;我的记录</a></dd>
                ...
                <li class="layui-nav-item">
                    ...
                    <a href="javascript:;" id=><i class="fa fa-graduation-cap"></i>&nbsp;学科管理</a>

                    <dl class="layui-nav-child">

                        <dd><a href="javascript:;"id="" onclick="showTab(1,'/courseadd.html','学科新增')">&nbsp;&nbsp;&nbsp;&nbsp;专业新增</a></dd>

                        <dd><a href="javascript:;"id="" onclick="showTab(1,'/courselist.html','学科列表')">&nbsp;&nbsp;&nbsp;&nbsp;专业列表</a></dd>
